# need to import first, session, and flash!
...
# need to change SQLAlchemy to my DB info
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://flicklist:root@localhost:3306/flicklist'
...
# Need to create new routes, and methods for register
...
# need to verify that their input is an email
def is_email(string):
...
# need to create new routes and methods for logout
